...
'''
Read image from video stream and pass through model
Params:
    model: model to pass image through
    im_size: image dimension to resize frames from video to
    device: cpu or gpu
Returns:
Pop-up window showing annotated images in real time
'''
