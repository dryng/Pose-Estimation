import time
from utils import utils, visualizations
...
'''
Traing model with static learning rate
Params:
...
'''
Traing model with cyclical learning rate
Params:
    model: model to train
    train_iterator: training data
    val_iterator: validation data
    base_lr: base learning rate
    max_lr: max learing rate
    step_size: step size
    n_epochs: number of epochs to train for
    device: cpu or gpu
    path: where to save model to
